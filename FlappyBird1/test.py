#This is the FlappyBird game develloped in Python
# This is the FlappyBird game develloped in Python
# Ferdinand, Beverly , Ana
...
def collisionDetection():
    ...
    if d >= ground:
        game = False
    if ((((c + 20) >= x1 - (50 / 2) and (c) <= x1 + 50 and d >= (y1 - 25))) or (
            (c + 20) >= x3 - (50 / 2) and (c) <= x3 + 50 and d >= (y3 - 25))):
        game = False
    if (((c + 20) >= x2 - (50 / 2) and (c) <= x2 + 50 and d <= y2 + 190) or (
            (c + 20) >= x4 - (50 / 2) and (c) <= x4 + 50 and d <= y4 + 190)):
        game = False
